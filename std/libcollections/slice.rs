    ...
    while width < len {
        ...
        for start in (0..len).step_by(2 * width) {
            ...
            unsafe {
                ...
                let right_start =
                    buf_dat.offset(cmp::min(start + width, len) as isize);
                ...
                if right != right_end &&
                   compare(&*right.offset(-1), &*right) != Greater {
                    let elems = (right_start as usize - left as usize) /
                                mem::size_of::<T>();
                ...
                while out < out_end {
                    ...
                    if left == right_start {
                        ...
                        let elems = (right_end as usize - right as usize) /
                                    mem::size_of::<T>();
