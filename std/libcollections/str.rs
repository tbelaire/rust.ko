...
impl str {
    ...
    #[inline]
    pub unsafe fn slice_mut_unchecked(&mut self,
                                      begin: usize,
                                      end: usize)
                                      -> &mut str {
    ...
    /// ```
    #[stable(feature = "rust1", since = "1.0.0")]
    pub fn split_terminator<'a, P: Pattern<'a>>(&'a self,
                                                pat: P)
                                                -> SplitTerminator<'a, P> {
    ...
    /// ```
    #[stable(feature = "rust1", since = "1.0.0")]
    pub fn rsplit_terminator<'a, P: Pattern<'a>>(&'a self,
                                                 pat: P)
    ...
    /// ```
    #[stable(feature = "rust1", since = "1.0.0")]
    pub fn splitn<'a, P: Pattern<'a>>(&'a self,
                                      count: usize,
                                      pat: P)
                                      -> SplitN<'a, P> {
    ...
    /// ```
    #[stable(feature = "rust1", since = "1.0.0")]
    pub fn rsplitn<'a, P: Pattern<'a>>(&'a self,
                                       count: usize,
                                       pat: P)
                                       -> RSplitN<'a, P>
        where P::Searcher: ReverseSearcher<'a>
    ...
    pub fn match_indices<'a, P: Pattern<'a>>(&'a self,
                                             pat: P)
                                             -> MatchIndices<'a, P> {
    ...
    /// ```
    #[stable(feature = "str_match_indices", since = "1.5.0")]
    pub fn rmatch_indices<'a, P: Pattern<'a>>(&'a self,
                                              pat: P)
                                              -> RMatchIndices<'a, P>
        where P::Searcher: ReverseSearcher<'a>
    {
    ...
    pub fn to_lowercase(&self) -> String {
        ...
        fn map_uppercase_sigma(from: &str, i: usize, to: &mut String) {
            ...
            let is_word_final = case_ignoreable_then_cased(from[..i]
                                                               .chars()
                                                               .rev()) &&
                                !case_ignoreable_then_cased(from[i + 2..]
                                                                .chars());
