...
impl<T> VecDeque<T> {
    ...
    unsafe fn wrap_copy(&self, dst: usize, src: usize, len: usize) {
        ...
        debug_assert!(cmp::min(diff(dst, src), self.cap() - diff(dst, src)) +
                      len <= self.cap(),
                      "wrc dst={} src={} len={} cap={}",
                      dst,
                      src,
...
impl<T> VecDeque<T> {
    ...
    pub fn reserve(&mut self, additional: usize) {
        ...
        let new_cap = used_cap.checked_add(additional)
                              .and_then(|needed_cap| {
                                  needed_cap.checked_next_power_of_two()
                              })
    ...
    pub fn shrink_to_fit(&mut self) {
        ...
        let target_cap = cmp::max(self.len() + 1, MINIMUM_CAPACITY + 1)
                             .next_power_of_two();
        ...
        match (contiguous,
            ...
            (false, true, false) => {
                unsafe {
                    ...
                    self.copy(self.tail + 1,
                              self.tail,
                              self.cap() - self.tail - 1);
    ...
    pub fn split_off(&mut self, at: usize) -> Self {
        ...
        unsafe {
            ...
            if at < first_len {
                ...
                ptr::copy_nonoverlapping(first_half.as_ptr()
                                                   .offset(at as isize),
                                         other.ptr(),
                                         amount_in_first);
        ...
        match (tail_len, head_len) {
            ...
            _ => unsafe {
                if tail_len <= head_len {
                    source_deque.tail = source_deque.wrap_sub(drain_head,
                                                              tail_len);
                    source_deque.wrap_copy(source_deque.tail,
                                           orig_tail,
                                           tail_len);
                } else {
                    source_deque.head = source_deque.wrap_add(drain_tail,
                                                              head_len);
            ...
            for len in 0..final_len {
                ...
                for tail_pos in 0..usable_cap {
                    ...
                    if back {
                        ...
                        for i in 0..len {
                            assert_eq!(tester.swap_remove_back(i),
                                       Some(len * 2 - 1 - i));
                        }
                    } else {
                        for i in 0..len * 2 {
                        ...
                        for i in 0..len {
                            ...
                            assert_eq!(tester.swap_remove_front(idx),
                                       Some(len * 2 - 1 - i));
                        }
                    }
